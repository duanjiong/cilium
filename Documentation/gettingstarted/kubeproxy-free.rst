...
of `Maglev <https://storage.googleapis.com/pub-tools-public-publication-data/pdf/44824.pdf>`_
...
fixed built-in seed. The seed is a 16 byte random number that is base64 encoded, and can be
